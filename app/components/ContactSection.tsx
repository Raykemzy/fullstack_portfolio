      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Ready to turn your idea into a reality? I specialize in building
            seamless, high-performance applications across web and mobile
            platforms, delivering exceptional user experiences.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="mailto:ukemzyukofia@gmail.com"
          ...
          <div className="flex justify-center gap-6">
            <a
              href="https://github.com/Raykemzy"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/ukeme-ukofia-a51583103/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-full"
            >
