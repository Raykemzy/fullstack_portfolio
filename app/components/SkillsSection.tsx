...
const skills: Skill[] = [
  { name: "Flutter", level: 80, platform: "Cross-Platform", yearsOfExperience: 3},
  { name: "Typescript", level: 70, platform: "Web", yearsOfExperience: 2},
  { name: "React", level: 65, platform: "Web", yearsOfExperience: 2},
  { name: "Dart", level: 75, platform: "Cross-Platform", yearsOfExperience: 3},
  { name: "Firebase", level: 85 },
  { name: "App Store Optimization", level: 80 },
  { name: "Functional Shape-up", level: 75 },
                ...
                <div className="flex flex-wrap sm:flex-nowrap justify-between mb-2 gap-2">
                  <div className="flex flex-wrap sm:flex-nowrap items-center gap-2">
                    ...
                    <div className="flex flex-wrap sm:flex-nowrap gap-1">
                      ...
                      {skill.name === "Swift" && (
                        <span className="px-2 py-0.5 text-xs rounded-full bg-orange-500/10 text-orange-400 border border-orange-500/20">
                          iOS
                        </span>
                      )}
                      {skill.name === "Kotlin" && (
                ...
                >
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-10 transition-opacity duration-500">
                    {skill.name.includes("Firebase") ? (
                      ...
                      <svg
                        className="absolute -right-4 -bottom-4 w-24 h-24 transform rotate-12"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                      >
                        <path d="M12,16L19.36,10.27L21,9L12,2L3,9L4.63,10.27M12,18.54L4.62,12.81L3,14.07L12,21.07L21,14.07L19.37,12.8L12,18.54Z" />
